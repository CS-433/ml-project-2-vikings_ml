...
if __name__ == "__main__":
    dir_images = "data/original/images"
    dir_masks = "data/original/groundtruth"
    destination_dir_images = "data/training_double/images"
    destination_dir_masks = "data/training_double/groundtruth"
